...
class DiscountShopsRelationManager extends RelationManager
{
    protected static string $relationship = 'discountShops';
    ...
    public function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('shope_name')->limit(50),
