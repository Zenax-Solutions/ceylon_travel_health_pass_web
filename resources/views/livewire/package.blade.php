<div>
                ...
                <div x-show.transition="step != 'complete'">
                    ...
                    <div class="py-4 border-b-2">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            ...
                            <div class="flex items-center md:w-64">
                                ...
                                <div class="w-10 text-xs font-bold text-gray-600"
                    ...
                    <div class="py-10">
                            ...
                            <div
                                ...
                                <div class="mt-4">
                                    <div class="flex max-h-[400px] w-full flex-col overflow-y-scroll">
                                        ...
                                        <h1 class="my-2 px-4 text-[15px] text-green-400 text-bolder font-bold">Shop's
                                            List</h1>
                                        ...
                                        @forelse ($package->discount_shop_list as $shopId)
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p class="text-[15px] text-black font-bold">{{ $shop->shope_name }}
                                                    </p>
                                        ...
                                        <h3 class="my-2 px-4 text-[15px] text-gray-400 font-bold">Service's List</h3>
                        ...
                        <div x-show.transition.in="step === 2">
                            ...
                            <div
                                class="w-full px-2 py-4 bg-white border border-gray-200 shadow-md rounded-xl shadow-gray-100">
                                <div class="font-bold text-gray-800 md:flex">
                                    ...
                                    <div class="flex w-full space-x-3 md:w-1/2">
                                        <div class="w-1/2">
                                            ...
                                            <p wire:transition><span id="totalPrice"
                                                    class="text-xl text-green-400 text-normal">{{ env('CURRENCY', '$') . $totalPrice }}</span>
                                            </p>
                                        </div>
                                        <div class="w-1/2">
                                            <h2 class="text-gray-500">Grand Total:</h2>
                                            <p wire:transition><span id="grandTotal"
                                                    class="text-xl text-red-400 text-normal">{{ env('CURRENCY', '$') . $grandTotal }}</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <p class="text-[15px] text-light text-green-500">
                                                            ...
                                                            @if ($auth_customer != null)
                                                                @if ($auth_customer->region_type == 'south_asian')
                                                                    Adult:
                                                                    {{ env('CURRENCY', '$') . $destination->south_asian_price }}
                                                                    <br>
                                                                    @if ($destination->child_south_asian_price > 0)
                                                                        Children:
                                                                        {{ env('CURRENCY', '$') . $destination->child_south_asian_price }}
                                                                    @endif
                                                                @elseif ($auth_customer->region_type == 'non_south_asian')
                                                                    Adult:
                        ...
                        <div x-show.transition.in="step === 3">
                            ...
                            <div x-show="$wire.destinationsCount < 1">
                                <div class="w-full mb-3 text-sm font-bold text-white bg-red-500 rounded-md shadow-lg"
                                    role="alert">
                                    <div class="flex p-4">
                                ...
                                <form>
                                    <div class="grid gap-6 mb-6 lg:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ str_replace('_', ' ', $auth_customer?->region_type) }}"
                                                readonly required>
                                        </div>
                                    ...
                                    <div class="flex items-center justify-center pt-4">
                                        ...
                                        <div class="w-full mx-auto">
                                            ...
                                            <div class="mb-5">
                                                <label for="adult"
                                                    class="block mb-3 text-base font-medium text-white">
                                                    Adult Count
                                                </label>
                                                <input type="number" min="1" wire:model.blur='adult_count'
                                                    required
                                                ...
                                                @if ($package?->child_price == 1)
                                                    <label for="children"
                                                        class="block mt-3 mb-3 text-base font-medium text-white">
                                                        Children Count
                                                    </label>
                                                    <input type="number" min="0"
                                                        wire:model.blur='children_count'
                                                        class="w-full appearance-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                            ...
                                            <div x-data="{ toggal: $wire.entangle('esimOption').live }">
                                                ...
                                                <div x-show="toggal" class="mt-4" x-transition>
                                                    ...
                                                    <label
                                                        class="block mt-2 mb-2 text-sm font-medium text-white">Select
                                                        E-Sim Provider</label>
                                                    <select wire:model.blur="esimServiceProvider"
                                                        class="text-black text-sm rounded-lg font-bold block w-full p-2.5">
                                                    ...
                                                    <div>
                                                        @for ($i = 0; $i < $esimCount; $i++)
                                                            <div class="w-full pt-4 pb-4">
                                                                <div
                                                                    class="relative grid w-full grid-cols-1 bg-gray-100 border border-gray-300 rounded-lg md:grid-cols-3">
                                                                    <div
                                                                        class="flex flex-col items-center justify-center p-4 bg-gray-200 border-0 border-r border-gray-300 rounded-l-lg ">
                                                                        <label
                                                                            class="inline-flex items-center px-2 py-2 my-2 text-xs font-semibold tracking-widest uppercase transition duration-150 ease-in-out bg-gray-900 border border-transparent rounded-md shadow-md cursor-pointer hover:opacity-80 text-gray-50 hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25"
                                                                            for="passportImages.{{ $i }}">

                                                                            Upload Passport
                                                                            <input
                                                                                id="passportImages.{{ $i }}"
                                                                                wire:model.live="passportImages.{{ $i }}"
                                                                                accept="image/*"
                                                                                class="hidden text-sm cursor-pointer w-36"
                                                                                type="file">
                                                                        </label>
                                                                        <button type="button"
                                                                            wire:click='removeEsim({{ $i }})'
                                                                    ...
                                                                    <div
                                                                        class="relative flex items-center justify-center order-first col-span-2 m-2 bg-center bg-no-repeat bg-cover border border-gray-400 border-dashed rounded-lg md:order-last h-28 md:h-auto bg-origin-padding">

                                                                        @if ($passportImages && isset($passportImages[$i]))
                                                                            <img style="width:200px"
                                                                                src="{{ $passportImages[$i]->temporaryUrl() }}">
                                                                        @endif

                                                                        <div wire:loading
                                                                            wire:target="passportImages.{{ $i }}">
                                                ...
                                                <div class="pt-6 text-gray-800">
                                                    ...
                                                    <div class="flex items-center w-full">
                                                        ...
                                                        <div class="pl-3">
                                                            ...
                                                            @php
                                                                ...
                                                                $sub_total = $children_count * $totalOfChildPrice;

                                                                $total =
                                                                    $sub_total +
                                                                    $grandTotal * $adult_count +
                                                                    $esimCount * $esimProviderPrice;
                                                            @endphp
                                                            <span
                                                                class="text-xl font-semibold text-red-400">{{ env('CURRENCY', '$') . $total - $discount }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    @if ($coupon_data != null)
                                                        <div wire:transition
                                                            class="flex items-center justify-between w-full p-6 space-x-6 bg-white">
                                                            <div class="flex-1 truncate">
                                                                <div class="flex items-center space-x-3">
                                                                    <h3
                                                                        class="text-sm font-medium text-green-400 truncate">
                                                                        {{ $coupon_data[0]['name'] }}</h3>
                                                                    <span
                                                                        class="inline-flex flex-shrink-0 items-center rounded-full bg-green-50 px-1.5 py-0.5 text-xs font-medium text-blue-600 ring-1 ring-inset ring-green-600/20">Tour
                                                                        Agent</span>
                                                                </div>
                                                                <p
                                                                    class="mt-1 text-sm font-light text-gray-500 truncate">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="w-full text-right">
                            <button x-show="step < 2" @click="step++"
                                class="px-5 py-2 font-medium text-center text-white bg-blue-500 border border-transparent rounded-lg shadow-sm focus:outline-none hover:bg-blue-600">
                                Select Attractions
                            </button>

                            <button @click="step++" x-show="step == 2"
                                class="px-5 py-2 font-medium text-center text-white bg-black border border-transparent rounded-lg shadow-sm focus:outline-none hover:bg-white hover:text-green-500">🛒
                                Chekout ( {{ env('CURRENCY', '$') . $total - $discount }} )</button>

                            <div x-show="$wire.destinationsCount >= 1" wire:loading.remove>
                                <button wire:click.prevent='submitBooking()' x-show="step === 3"
                                    class="px-5 py-2 font-medium text-center text-white bg-red-400 border border-transparent rounded-lg shadow-sm focus:outline-none hover:text-dark">Pay
                                    Online( {{ env('CURRENCY', '$') . $total - $discount }} )</button>
                            </div>

                            <div wire:loading wire:target="submitBooking()">
                                <div class="flex space-x-2 animate-pulse">
                                    <div class="w-3 h-3 bg-red-300 rounded-full">
                                    </div>
                                    <div class="w-3 h-3 bg-red-500 rounded-full">
                                    </div>
                                    <div class="w-3 h-3 bg-red-700 rounded-full">
                                    </div>
                                </div>
                            </div>
    ...
    <div x-show="$wire.showModal" x-transition.duration.1500ms class="flex items-center justify-center" x-cloak>
        <!-- Background overlay -->
        <div
            class="fixed inset-0 flex items-center justify-center overflow-hidden bg-gray-500 bg-opacity-90 backdrop-blur">
            <!-- Modal -->
            <div class="fixed inset-0 z-10 flex items-center justify-center overflow-y-auto">
                <!-- Modal panel -->
                <div
                    class="overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:max-w-lg sm:w-full">
                    <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        ...
                        <div>
                            <div class="w-full mt-3 text-center sm:mt-0 sm:text-left">
                                <form action="{{ route('customer.login.validate', ['redirect' => 'package']) }}"
                                    method="POST">
                                    @csrf
                                    <div class="flex flex-col w-full space-y-5">
                                        ...
                                        @error('email')
                                            <span wire:transition
                                                class="font-light text-red-600 invalid-feedback">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <p class="mt-4 text-sm font-bold text-black sm:mt-0">
                                            ...
                                            <a href="{{ route('customer.register') }}"
                                                class="text-gray-700 underline">Register here</a>.
                                        </p>

                                        <button type="submit"
                                            class="flex items-center justify-center flex-none px-3 py-2 font-medium text-white bg-green-400 rounded-lg md:px-4 md:py-3">Login</button>

                                        <a href="/"
                                            class="flex items-center justify-center flex-none px-3 py-2 font-medium text-white bg-black rounded-lg md:px-4 md:py-3">Back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        ...
        function calculateTotal() {
            ...
            var grandTotal = packagePrice + totalPrice;
