...
<body>
    ...
    <nav style="background-color: #e3efc9; padding:10px"
        ...
        <div class="hidden lg:flex lg:justify-between lg:items-center">
            ...
            <ul class="flex items-center ml-4 space-x-4 text-sm font-semibold">
                ...
                <li><a href="{{ route('agent.packages') }}"
                        class="px-2 py-2 text-gray-800 rounded-md xl:px-4 hover:bg-gray-200">Packages</a>
                </li>
                <li><a href="{{ route('agent.profile') }}"
                        class="px-2 py-2 text-gray-800 rounded-md xl:px-4 hover:bg-gray-200">My Profile</a>
                </li>
    ...
    <main>
        ...
        <livewire:package :tour_agent_mode="'true'">
