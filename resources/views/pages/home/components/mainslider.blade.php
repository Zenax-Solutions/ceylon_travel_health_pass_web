...
<div id="default-carousel" class="relative w-full">
    ...
    width: 100%; background: linear-gradient(61deg, #000000cf, #ffffff00);">
            <div class="swiper-wrapper" style="z-index: -1;">
                <!-- Slide 1 -->
                <div class="swiper-slide">
                    <video class="video-bg" autoplay loop muted>
                        <source src="{{asset('video/video_1.webm')}}" type="video/mp4">
        ...
        <div class="container flex flex-col mx-auto" style="padding: 10px; margin-top: 70px;">
            <div class="grid w-full grid-cols-1 my-auto mt-12 mb-8 md:grid-cols-2" style="z-index: 2;">
                <div class="flex flex-col justify-center text-center md:text-left lg:text-left lg:text-start">
                    ...
                    <div class="p-6 mb-8 md:pl-0 lg:pl-0 space-y-4">
                        <div class="relative w-full grid justify-items-center md:justify-items-start md:flex md:items-center md:gap-7">
                        ...
                        <div class="relative w-full grid justify-items-center md:justify-items-start md:justify-items-start md:flex md:items-center md:gap-7">
                    ...
                    <div class="flex justify-center md:justify-start lg:justify-start pb-8">
                        <a href="#buynow" class="flex w-40 select-none items-center gap-3 rounded-lg bg-green-500 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-green-500/20 transition-all hover:shadow-lg hover:shadow-green-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button" data-ripple-light="true">
