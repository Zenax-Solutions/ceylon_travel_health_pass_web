   ...
   <footer class="font-sans" style="background-color: #e3efc9;">
       <div class="container px-6 py-12 mx-auto" style="font-weight: 400;">
           <div
               class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4 text-center md:text-left lg:text-left">
               ...
               <div>
                   ...
                   <div class="flex flex-col items-center md:items-start lg:items-start mt-5 space-y-2">
                       <p
                           class="text-black transition-colors duration-300  dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">
               ...
               <div>
                   ...
                   <div class="flex flex-col items-center md:items-start lg:items-start mt-5 space-y-2">
                       <a href="/"
                           class="text-gray-600 transition-colors duration-300 dark:text-black dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Home</a>

                       <a href="{{ route('shops') }}"
                           class="text-gray-600 transition-colors duration-300 dark:text-black dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Shops</a>

                       <a href="{{ route('services') }}"
                           class="text-gray-600 transition-colors duration-300 dark:text-black dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Services</a>

                       <a href="{{ route('review') }}"
                           class="text-gray-600 transition-colors duration-300 dark:text-black dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Review
                           Us</a>
               ...
               <div>
                   ...
                   <div class="flex flex-col items-center md:items-start lg:items-start mt-5 space-y-2">
                       <a href="{{ route('privacy-policy') }}"
                           class="text-gray-600 transition-colors duration-300 dark:text-black dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Privacy
                           Policy</a>

                       <a href="{{ route('terms-and-conditions') }}"
                           class="text-gray-600 transition-colors duration-300 dark:text-black dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Terms
                           and Conditions</a>
               ...
               <div>
                   ...
                   <div class="flex flex-col items-center md:items-start lg:items-start mt-5 space-y-2">
                       <a href="{{ route('agent.login') }}"
                           class="text-black transition-colors duration-300 dark:text-black dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Agent
                           Portal</a>

                       <a href="{{ route('destination.login') }}"
                           class="text-black transition-colors duration-300 dark:text-black dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Destination
                           Portal</a>
                       <button id="pwa-download-btn" style="display: none;"
