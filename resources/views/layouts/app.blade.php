    ...
    <div id="main-content" style="display:none;">
        ...
        <div x-data="{ open: false }"
            ...
            <div style="padding: 10px;"
                class="container  relative gap-4 flex flex-wrap items-center justify-between md:justify-center lg:justify-between w-full rounded-md group py-7 shrink-0">
                <div>
                    <a href="/">
                        <x-logo></x-logo>
                    </a>
                ...
                <div x-show="open" x-transition style="margin-top: 5px;"
                    class="w-full flex md:hidden transition-all duration-300 ease-in-out flex-col items-start shadow-main justify-center w-full overflow-hidden bg-white  group-[.open]:py-4 rounded-2xl  top-full">
                    <div class="p-2"
                        style="    display: flex;
